# https://leetcode.com/problems/coin-change/solutions/4262165/memoization-approach-c-solution/
        ...
        def Solution1(coins, amount):
            ...
            def solution(amount):
                ...
                for (
                    ...
                    coins
                ):  # lets start first from the largest coins, so we get to the base cases quicker
                    n_coins = solution(amount - coin)
                    min_coins = min(
                        min_coins, n_coins + 1
                    )  # get the best solution of this node's children. We add 1, and that is the best solution of this node.
